...
public class TrocarSenhaMesario extends javax.swing.JFrame {
    MySQL conectar = new MySQL();
    String senha;
    String usuario;
    public TrocarSenhaMesario(String usu) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 150, 50));
        ...
        txtSenhaConfirm.setBackground(new java.awt.Color(255, 255, 255));
        txtSenhaConfirm.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        txtSenhaConfirm.setForeground(new java.awt.Color(4, 21, 111));
        txtSenhaConfirm.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(4, 21, 111)));
        jPanel1.add(txtSenhaConfirm, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 230, 240, 50));

        txtSenhaAtual.setBackground(new java.awt.Color(255, 255, 255));
        txtSenhaAtual.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        txtSenhaAtual.setForeground(new java.awt.Color(4, 21, 111));
        txtSenhaAtual.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(4, 21, 111)));
        jPanel1.add(txtSenhaAtual, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 240, 50));

        txtSenha.setBackground(new java.awt.Color(255, 255, 255));
        txtSenha.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        txtSenha.setForeground(new java.awt.Color(4, 21, 111));
        txtSenha.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(4, 21, 111)));
        jPanel1.add(txtSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, 240, 50));
    ...
    private void ConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmarActionPerformed
        if(!txtSenha.getText().equals("") && !txtSenhaAtual.getText().equals("")&&!txtSenhaConfirm.getText().equals("")){
            if(txtSenhaAtual.getText().equals(senha)){
                if(txtSenha.getText().equals(txtSenhaConfirm.getText())){
                    ...
                    if(status){JOptionPane.showMessageDialog(null, "Troca de senha realizada com sucesso");
                        LimparCampos();
                        dispose();
                    }else{ JOptionPane.showMessageDialog(null, "Houve um erro na troca de senha, tente novamente");
                    }
                } catch (Exception e) {
                    e.getMessage();
                    JOptionPane.showMessageDialog(null, "Houve um erro na troca de senha");
                } finally {conectar.fechaBanco();
                }
            }else{
                txtSenha.setText("");
                txtSenhaConfirm.setText("");
                JOptionPane.showMessageDialog(null, "As senhas estão diferentes!","Trocar Senha",JOptionPane.ERROR_MESSAGE);
            }
        }else{
            txtSenhaAtual.setText("");
            JOptionPane.showMessageDialog(null, "A senha atual está errada!","Trocar Senha",JOptionPane.ERROR_MESSAGE);
        }
        }else{
            JOptionPane.showMessageDialog(null, "Preencha todos os campos!","Trocar Senha",JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrocarSenhaMesario("").setVisible(true);
            }
        });
    }
